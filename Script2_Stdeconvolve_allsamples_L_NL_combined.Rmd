...
# output: 1. lda file with 8-60 topics: "ldas_noKRTigG_allOD_k8to60_lesiononly.Rdata", 2. final Seurat obj with final selected (and combined) 23 topics added: integrated_Eth_cohort_filtered_23stdeconvTopics_labelled
...
integrated_Eth_cohort <- readRDS(
  paste0(read_path, "Eth4mm_renamed_res_addedabundances_pid_sampleid_tratio0.6dims1_15_cohort.rds"))
...
saveRDS(
  ldas5, 
  paste0(save_path, "ldas_noKRTigG_allOD_k8to60_lesiononly.Rdata")
)
...
ldas5 <- readRDS(paste0(save_path, "ldas_noKRTigG_allOD_k8to60_lesiononly.Rdata"))
...
output_file <- paste0(save_path, "integrated_Eth_cohort_filtered_", 
                      n_topics_combined, "stdeconvTopics_labelled.rds")
