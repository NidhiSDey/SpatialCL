...
# input: "Eth4mm_renamed_res_addedabundances_pid_sampleid_tratio0.6dims1_15_cohort.Rds"
# output: 1. lda file with 26-52 topics: "lesion_26_52topics_stdeconv.rds", 2. final Seurat obj with final selected (and combined) 35 topics added: Lesion_integrated_Eth_cohort_filtered_35_stdeconvTopics_reclus_relabelled_COMBINED_dominantTopic_added.rds"
...
integrated_Eth_cohort <- readRDS(paste0(read_path, 
  "Eth4mm_renamed_res_addedabundances_pid_sampleid_tratio0.6dims1_15_cohort.Rds"))
```
...
# # Save results
# saveRDS(ldasl26_52, 
#         paste0(save_pathL, "lesion_26_52topics_stdeconv.rds"))
# cat("Results saved to:", paste0(save_pathL, "lesion_26_52topics_stdeconv.rds\n"))
# ```
...
ldas_list <- readRDS(paste0(save_pathL, "lesion_26_52topics_stdeconv.rds"))
...
saveRDS(integrated_Eth_cohort_filteredL, paste0(save_pathL, "Lesion_integrated_Eth_cohort_filtered_", 
         n_topics_added, "stdeconvTopics_reclus_relabelled_COMBINED_dominantTopic_added.rds"))
```
```{r}
# ==============================================================================
# FIGURE S2A
