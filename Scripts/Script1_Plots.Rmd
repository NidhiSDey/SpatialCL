...
# and uses "integrated_seurat_obj.Rds"" for this 
# ==============================================================================
...
integrated_Eth_cohort <- readRDS(
  paste0(save_path, "integrated_seurat_obj.Rds")
)
...
# # Update Object
# # ------------------------------------------------------------------------------
# integrated_Eth_cohort <- UpdateSeuratObject(integrated_Eth_cohort)
# saveRDS(integrated_Eth_cohort, paste0(save_path, "integrated_seurat_obj_updated.Rds"))
# ------------x------------------------------------------------------------------
...
DefaultAssay(integrated_Eth_cohort)
