...
mat <- GetAssayData(integrated_Eth_cohort_filteredL, layer = "scale.data")[top_genes, ]
...
p <- SCpubr::do_BoxPlot(
  ...
  use_test = TRUE, colors.use = c("P1_L" = "#E64B35", "P2_L" = "#4DBBD5", 
           "P3_L" = "#00A087", "P4_L" = "#3C5488", "P5_L" = "#F39B7F"),
...
mat <- GetAssayData(P1_subset, layer = "scale.data")[top_genes, ]
...
col_anno <- HeatmapAnnotation(
  ...
  col = list(
    ...
    Comparison = c("P1_L" = "#E64B35", "P1_NL" = "#4DBBD5")
  )
)
