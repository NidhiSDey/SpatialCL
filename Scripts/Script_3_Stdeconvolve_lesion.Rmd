...
```{r}
# ============================================
# PART 4: Supplementary Figure 2B-C
# ============================================
...
pdf(paste0(save_pathL, "S2B_C_lesion_", n_topics_combined, "topics_COMBINED_top6genes.pdf"), 
...
top_genes_data <- read.csv(paste0(save_pathL, "lesion_35topics_COMBINED_top40_genes.csv"),
                           stringsAsFactors = FALSE)
...
output_file <- paste0(save_pathL, "Supplementary_Table2__STdeconvolve_Topics.csv")
...
saveRDS(integrated_Eth_cohort_filteredL, paste0(save_pathL, "lesion_only_integrated_obj_", 
         n_topics_added, "_LDA_topics_added.rds"))
```
