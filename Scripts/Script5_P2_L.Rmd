...
# Load lesion + non-lesion integrated object (for P2_L vs P2_NL comparison)
...
mat_up_p2 <- GetAssayData(integrated_Eth_cohort_filteredL, layer = "scale.data")[top_up_p2, ]
