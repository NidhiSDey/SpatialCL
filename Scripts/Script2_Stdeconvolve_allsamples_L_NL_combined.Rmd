...
# output: 1. lda file with 8-60 topics: "combined_lda_model_k8_60.Rdata", 2. final Seurat obj with final selected (and combined) 23 topics added and updated to SeuratObject_5.4.0: "integrated_seurat_obj_26_LDA_topics_added.rds"
...
# Update to the lastest seurat version 
 integrated_Eth_cohort_filtered<- UpdateSeuratObject(integrated_Eth_cohort_filtered)

# Save integrated object with STdeconvolve results
output_file <- paste0(save_path, "integrated_seurat_obj_23_LDA_topics_added_updated.rds")
